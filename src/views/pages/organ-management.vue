                    ...
                    <el-table :data="schoolData" style="width: 100%; margin-top: 20px" v-loading="loading.school">
                        ...
                        <el-table-column label="操作" width="180" fixed="right" align="center">
                            <template #default="scope">
                                <el-button size="small" type="primary" @click="handleEdit('school', scope.row)">编辑</el-button>
                                <el-button size="small" type="danger" @click="handleDelete('school', scope.row)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
                ...
                <div class="container">
                    <div class="department-layout">
                        ...
                        <div class="table-container">
                            ...
                            <el-table :data="filteredDepartmentData" style="width: 100%; margin-top: 20px" v-loading="loading.department">
                                <el-table-column type="index" label="序号" width="55" align="center" />
                                ...
                                <el-table-column label="操作" width="180" fixed="right" align="center">
                                    <template #default="scope">
                                        <el-button size="small" type="primary" @click="handleEdit('department', scope.row)">编辑</el-button>
                                        <el-button size="small" type="danger" @click="handleDelete('department', scope.row)">删除</el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                        </div>
...
const handleDelete = (type: "department" | "school", row) => {
    ...
    ElMessageBox.confirm(`确认删除该${title}吗？`, "警告", {
...
const submitForm = async (type: "department" | "school") => {
    ...
    await formRef.validate(async (valid) => {
        if (valid) {
            try {
                const url = type === "department" ? (isEdit.value ? "/dept/updateDept" : "/dept/addDept") : isEdit.value ? "/dept/updateSchool" : "/dept/addSchool";
