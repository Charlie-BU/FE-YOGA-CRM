            ...
            <div class="course-layout">
                ...
                <div class="table-container">
                    ...
                    <div class="pagination" style="margin-top: 20px; text-align: right">
                        <el-pagination v-model:current-page="page.index" v-model:page-size="page.size" :total="page.total" @current-change="changePage" layout="total, prev, pager, next" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="主讲教师" prop="chiefTeacherId">
                            <el-select v-model="formData.chiefTeacherId" placeholder="请选择主讲教师" style="width: 100%" @change="handleTeacherChange('chief')" filterable>
                    ...
                    <el-col :span="12">
                        <el-form-item label="班主任" prop="classTeacherId">
                            <el-select v-model="formData.classTeacherId" placeholder="请选择班主任" style="width: 100%" @change="handleTeacherChange('class')" filterable>
                                <el-option v-for="item in teacherOptions" :key="item.value" :label="item.label" :value="item.value" />
                            </el-select>
                        </el-form-item>
                    </el-col>
...
onMounted(async () => {
    try {
        await Promise.all([getSchools(), getCourses()]);
    } catch (error) {
...
// 处理教师选择
const handleTeacherChange = (type: "chief" | "class") => {
