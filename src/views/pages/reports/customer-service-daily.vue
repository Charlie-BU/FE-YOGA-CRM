    ...
    <div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="total" label="已成单总数" align="center" show-overflow-tooltip />
...
const handleQuery = async () => {
    ...
    try {
        ...
        const res = await request.post("http://8.153.204.238:85/user/getCustomerServiceDailyData", params, {
            headers: {
...
const handleExport = () => {
    ...
    // 生成文件名
    const fileName = `客服已成单数据_${schoolName}_${dateRange}.xlsx`;

    // 添加工作表到工作簿并导出
    XLSX.utils.book_append_sheet(wb, ws, "客服已成单数据");
